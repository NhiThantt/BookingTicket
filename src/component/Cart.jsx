    ...
    return (
      ...
      >
        <div className="position-relative bg-white shadow rounded-lg p-4 w-75">
            ...
            <tbody>
              {this.props.dataCart.map((item, i) => (
                <tr key={item.id}>
                  ...
                  <td>
                    <button onClick={() => this.props.onMinus(this.props.dataCart[i].product.id)} className="btn btn-success"> - </button>
                    <b className="mx-3">{item.quantity}</b>
                    <button onClick={() => this.props.onPlus(this.props.dataCart[i].product.id)} className="btn btn-success"> + </button>
                  </td>
          ...
          <button onClick={this.props.onCheckOut} className="btn btn-primary">Check out</button>
        </div>
      </div>
    );
  }
